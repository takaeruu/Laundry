...
public function join4tblwhere($tabel1, $tabel2, $tabel3, $tabel4, $on1, $on2, $on3, $where)
{
    return $this->db->table($tabel1)
                        ->join($tabel2, $on1, 'inner')
                        ->join($tabel3, $on2, 'inner')
...
public function join4tblnotnull($tabel1, $tabel2, $tabel3, $tabel4, $on1, $on2, $on3, $notNullColumn)
{
    return $this->db->table($tabel1)
                        ->join($tabel2, $on1, 'inner')
                        ->join($tabel3, $on2, 'inner')
