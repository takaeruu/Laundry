...
<div class="col-lg-10">
    ...
    <a href="<?= base_url('home/view_print_nota2/' . $pemesanan->kode_pemesanan . '/' . $bayar) ?>" id="printButton">
    <button class="btn btn-info btn-sm mr-2">
        <i class="fa fa-print mr-1"></i> Print
    </button>
</a>
        <a href="<?=base_url('home/antar_pemesanan/' .$pemesanan->kode_pemesanan)?>">
        <button class="btn btn-success btn-sm mr-2" id="antarButton">
            <i class="fa fa-save mr-1"></i> Antar
        </button>
        </a>
    </div>
</div>
...
<script>
    function printDiv(divId) {
        ...
        // Reload to restore the original page content
